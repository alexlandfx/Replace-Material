...
def repaintEntities(entities_to_scan, target_material, replacement_material)
...
command = UI::Command.new("Replace Selected Material") {replaceCurrentMaterial}
